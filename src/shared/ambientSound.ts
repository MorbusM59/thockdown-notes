...
export const AMBIENT_FACTORY_PRESETS: readonly AmbientPreset[] = [
  ...
  },
  {
    ...
    }, { size: 0.55, damping: 0.85, echoes: 0.05, amount: 0.65 }, { gustiness: 0.6, paceSec: 11 }),
  },
  {
    id: 'tent',
    name: 'Rain on a tent',
    settings: soundscape({
      'rain-1': { surface: 0.25, intensity: 0.55, dropTone: 0.45, washLevel: 0.45, drips: 0.35, dripLevel: 0.8, wetness: 0.1, resonance: 0.6, distance: 0, pan: -0.2, width: 0.9, volume: 0.76 },
      'rain-2': { surface: 0.25, intensity: 0.75, washLevel: 0.62, drips: 0.1, wetness: 0.05, resonance: 0.5, distance: 0.05, pan: 0.3, width: 0.8, volume: 0.7, weather: 0.5 },
      'rain-3': { surface: 0.05, intensity: 0.8, washLevel: 0.72, washDensity: 0.85, washTone: 0.4, drips: 0, wetness: 0.3, distance: 0.88, volume: 0.62, weather: 0.6 },
      'fire-1': { size: 0.15, width: 0.3, crackle: 0.25, crackleLevel: 0.6, pops: 0.12, popLevel: 0.6, sizzle: 0.9, sizzleLevel: 0.8, flicker: 0.3, flickerPeriodSec: 0.8, flickerDynamics: 0.2, distance: 0.7, pan: 0.65, volume: 0.5 },
      'noise-1': { colour: 0.4, brightnessHz: 1200, depth: 0.45, periodSec: 16, sweep: 0.5, variation: 0.6, sway: 0.4, distance: 0.75, volume: 0.5, weather: 1 },
      'thunder-1': { share: 0.04, distance: 1, pan: -0.5, spread: 0.9, character: 0.3, randomness: 0.6, lengthSec: 22, volume: 0.6 },
  ...
  },
  {
    ...
    settings: soundscape({
      ...
      'thunder-1': { volume: 0.86, share: 0.1, distance: 0.35, pan: -0.4, spread: 0.6, character: 0.75, contrast: 0.4, randomness: 0.6, lengthSec: 12, weather: 0.6 },
      'thunder-2': { volume: 0.82, share: 0.14, distance: 0.9, pan: 0.55, spread: 0.8, character: 0.35, randomness: 0.7, lengthSec: 24, weather: 0.4 },
    }, { size: 0.9, damping: 0.55, echoes: 0.35, amount: 0.75 }, { gustiness: 0.85, paceSec: 8 }),
  },
  {
    id: 'ocean',
    name: 'Rolling ocean',
