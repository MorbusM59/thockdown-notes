...
export const AMBIENT_FACTORY_PRESETS: readonly AmbientPreset[] = [
  ...
  },
  {
    ...
    name: 'Strong winds',
    settings: soundscape({
      'noise-1': { brightnessHz: 113.76, colour: 0.88, focus: 0.75, periodSec: 38.074, sweep: 0.24, volume: 0.75 },
      'noise-2': { brightnessHz: 1167.94, colour: 0.26, focus: 0.42, sweep: 0.2, volume: 0.7, weather: 1 },
      'noise-3': { brightnessHz: 562.18, colour: 0.17, curve: 0.13, distance: 0.67, focus: 0.11, periodSec: 29.969, skew: 0.23, sway: 0.03, sweep: 0.2, variation: 0.44, volume: 1, weather: 1 },
      'noise-4': { brightnessHz: 2778.24, colour: 0.7, focus: 0.19, sweep: 0.18, volume: 0.66 },
      'noise-5': { colour: 0.45, depth: 0.11, distance: 0.39, periodSec: 9.729, sway: 0.19, sweep: 0.22, variation: 0.92, volume: 0.76, weather: 0.63 },
      'noise-6': { brightnessHz: 10472.59, colour: 0.65, focus: 0.13, periodSec: 4.11, sway: 0.01, variation: 0.87, volume: 0.54 },
    ...
    }, { amount: 0.7, echoes: 0.55 }, { paceSec: 13 }),
  },
  {
    id: 'underwater',
    name: 'Under water',
