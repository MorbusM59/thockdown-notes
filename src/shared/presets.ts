...
export const DARK_FACTORY_PRESETS: UiLayoutLoadout[] = [
  { ...NEUTRAL_BASE, audioKeyVolume: 1, renderScrollDynamic: 1.5, renderScrollResponsiveness: 0.6, renderScrollMaxSpeedPxPerSec: 6000, filterInvert: 1, highlightColors: {"caret":"rgba(120, 115, 112, 0.8)","search":"rgba(199, 94, 0, 0.27)","selectionEdit":"rgba(199, 94, 0, 0.27)","selectionRender":"rgba(199, 94, 0, 0.27)","textBase":"rgba(51, 51, 51, 1)","textEmbossEdit":"#ffffff","textEmbossRender":"rgba(255, 255, 255, 1)","textEmbossUi":"rgba(255, 255, 255, 1)","background":"rgba(196, 187, 182, 0.196)","topBackground":"rgba(196, 187, 182, 0)","bottomBackground":"rgba(196, 187, 182, 0)","gridOutline":"rgba(0, 0, 0, 0.051)","grid":"rgba(255, 252, 249, 1)","base":"rgba(237, 234, 232, 1)","inputFields":"#ffffff","appButtons":"#FFFFFFBB","markdownHeadline":"rgba(0, 0, 0, 0.548)","markdownList":"rgba(38, 255, 0, 0.321)","markdownBlockquote":"rgba(11, 120, 236, 0.635)","markdownCode":"rgba(255, 0, 0, 1)","markdownChecked":"rgba(255, 0, 103, 0.321)","markdownUnchecked":"rgba(0, 226, 255, 1)"}, editorTextColors: {"editorEditText":"#000000DD","editorRenderText":"rgba(51, 51, 51, 1)"} },
