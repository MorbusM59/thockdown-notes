...
export const DARK_FACTORY_PRESETS: UiLayoutLoadout[] = [
  { ...NEUTRAL_BASE, audioKeyVolume: 1, renderScrollDynamic: 4, renderScrollResponsiveness: 0.6, renderScrollMaxSpeedPxPerSec: 30000, renderScrollSkew: 0.65, filterInvert: 1, glaze: {"sheenOpacity":0.03,"sheenPosition":0.12}, highlightColors: {"background":"rgba(196, 187, 182, 0.196)","base":"rgba(237, 234, 232, 1)","bottomBackground":"rgba(196, 187, 182, 0)","caret":"rgba(120, 115, 112, 0.8)","grid":"rgba(255, 252, 249, 1)","gridOutline":"rgba(0, 0, 0, 0.051)","markdownBlockquote":"rgba(11, 120, 236, 0.635)","markdownChecked":"rgba(255, 0, 103, 0.321)","markdownCode":"rgba(255, 0, 0, 1)","markdownHeadline":"rgba(0, 0, 0, 0.548)","markdownList":"rgba(38, 255, 0, 0.321)","markdownUnchecked":"rgba(0, 226, 255, 1)","search":"rgba(199, 94, 0, 0.27)","selectionEdit":"rgba(199, 94, 0, 0.27)","selectionRender":"rgba(199, 94, 0, 0.27)","textBase":"rgba(51, 51, 51, 1)","textEmbossRender":"rgba(255, 255, 255, 1)","textEmbossUi":"rgba(255, 255, 255, 1)","topBackground":"rgba(196, 187, 182, 0)"}, editorTextColors: {"editorRenderText":"rgba(51, 51, 51, 1)"} },
