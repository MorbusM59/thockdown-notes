...
- **Fire channels**: **size** runs from embers to a blaze — the weight and depth of the roar, and its hiss. **Crackle** is how often the wood crackles, **pops** how often sap pops and sizzles. **Hiss** is moisture boiling out of the wood: pockets that each sizzle for a while, fading in over a few seconds, holding with only a gentle waver, then fading out, several at once — none to the left, about four at once to the right. **Hiss tone** is the pitch of the sizzle, from a dull hiss to a thin, high one, without changing its loudness. Three sliders shape how the flames themselves move: **flicker** is how far the roar swings (a steady burn to the left, surging and faltering to the right), **pace** how often they change, and **edge** how sharp each change is — a soft swell that eases in and out, or an abrupt lurch.
