...
> **Where?**
> Settings panel -> Adventure.

*How hard ThockQuest is, and how much of a fight the space bar will play for you.*

- **Progression** is how much stronger monsters get with every level you clear, and **Luck** -- the slider, not the stat of that name -- is a thumb on the scale: it scales away your chance to *fail* and a monster's chance to *succeed*, so both sides go on reading the same stats while the fight tilts your way. Both start at their gentlest, so raising one is the first thing to do about a run that is going badly.
...
- **Hold space** is how far holding the space bar carries a fight on by itself -- nothing at all, to the end of the round, to the end of the fight, to the end of the stage, or to the end of the level -- and **hold speed** is how quickly, from a twentieth of a second between choices to a whole one. The speed slider is dead while the one above it says nothing.
