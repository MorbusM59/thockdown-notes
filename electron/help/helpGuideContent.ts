...
- **Hovering any pill on the lower bar spells it out in words.** The fight is told in glyphs to keep it short; the tooltip is where each one says what it means.
- **Difficulty is chosen from that opening screen**, under *Change Game Settings*: four presets, from one where monsters are half strength to one where they are stronger than you and get worse quickly. The one thing worth knowing is that a change applies to your **next** adventure and never to the one already running -- a run is played out at the setting it was begun at, so nothing you choose here can rewrite a fight you have already had.
