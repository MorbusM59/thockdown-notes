...
- The thumb's *size* is worked out from how many lines the note holds, once, when it opens — so it settles immediately and then stays put while you read, rather than adjusting itself as the app works the note out. It's an approximation, and a note full of pictures will have one that's a little generous.
