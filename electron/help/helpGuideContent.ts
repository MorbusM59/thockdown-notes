...
- **Thunder layers** peal now and then rather than playing continuously: the first comes within a few seconds of enabling one, and after that at random. Each peal rolls in gently, builds to its loudest a while in, and fades slowly. **Often** sets how many peals come in ten minutes, on average. **Character** runs from a smooth, low roll on the left to a cracking cascade of strikes on the right. **Distance** runs from near — bright and sharp — to far, a dark, smeared roll. **Pan** places the storm, **spread** sets how far each peal wanders across the sky, and **length** how long it rolls before dying away. Two or three layers at different distances and pans make a storm moving around you.
