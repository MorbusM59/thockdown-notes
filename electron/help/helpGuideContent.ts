...
- **Fire channels**: **size** runs from embers to a blaze — the weight and depth of the roar, and its hiss. **Crackle** is how often the wood crackles, **pops** how often sap pops and sizzles, and three sliders shape how the flames move: **flicker** is how far the roar and hiss swing (a steady burn to the left, surging and faltering to the right), **pace** how often they change, and **edge** how sharp each change is — a soft swell that eases in and out, or an abrupt lurch.
