...
- **Rain layers** control **volume** and **surface** — what the rain falls on, from soft on the left to hard on the right. At the far left it patters softly on leaves (**forest**); in the middle it splashes on pavement and plips into puddles (**street**); at the far right it rings brightly, like hail on glass (**glass**). Everything in between blends the two neighbours — something like soil or a wooden deck toward the leaves, a tin roof or a car toward the glass. **Drops** sets how many nearby drops you hear one by one each second, and **wash** the steady hiss of rain too dense to hear drop by drop — drops alone sound like dripping, the wash is what makes it rain. **Drips** adds large, heavy drops from gutters, eaves and branches. **Distance** moves a layer from near and distinct to far and diffuse, **pan** from left to right, and **bass** and **treble** set the low and high parts of each drop. Layering a near, a middle and a far layer — which the rain soundscapes do — gives the rain depth.
