...
- **Noise layers** control **volume**, **modulation amplitude** and **modulation period**; setting period to **0** selects bursts. Their remaining controls set burst **ramp**, **shape**, **speed**, noise type, average burst density, and filtering.
