...
- **Space** and **Weather**, the two buttons below the channels, belong to the whole soundscape. **Space** is the place every channel plays in: its **size** runs from a small room to a wide valley (how long it rings, and how late the first reflection comes), **damping** from a bright tail to one that darkens quickly the way open air and trees swallow the highs, **echoes** adds distinct reflections off walls, buildings or cliffs, and **amount** is how much of the space you hear at all. **Weather** is one slow rhythm of gusts and lulls for the whole scene: **gusts** is how strong they are, **pace** how often they come. A channel's own **weather** slider decides how closely it follows them — wind grows louder and brighter in a gust, rain gets heavier, a fire is fanned, chimes are struck more often and harder, and thunder comes sooner. At zero a channel ignores the weather entirely.
...
- **Fire channels**: **size** runs from embers to a blaze — the weight and depth of the roar, and its hiss. **Crackle** is how often the wood crackles, **pops** how often sap pops and sizzles.
