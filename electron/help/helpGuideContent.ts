...
- **Thunder layers** peal now and then rather than playing continuously: the first comes within a few seconds of enabling one, and after that at random. **Often** sets how many peals come in ten minutes, on average. **Distance** runs from near — a sharp clap and then a booming roll — to far, a low rumble that swells in slowly and rolls on; even the nearest never starts with a jump. **Pan** places the storm, **spread** sets how far each peal wanders across the sky as it rolls, and **length** how long it rolls before dying away. Two or three layers at different distances and pans make a storm moving around you.
